...
public enum ModArmorMaterial implements IArmorMaterial {
    GOD_GEM("god_gem", 37, new int[]{5, 10, 15, 5}, 30, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5.0F, 10F, () -> {
        return Ingredient.fromItems(ModItems.GOD_GEM.get());
    });
    ...
    public String getName() {
        return SuperEspada.MOD_ID + ":" + this.name;
    }
